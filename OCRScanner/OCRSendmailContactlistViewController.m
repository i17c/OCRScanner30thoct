...
@interface OCRSendmailContactlistViewController ()<UITableViewDataSource,UITableViewDelegate, UITextFieldDelegate, UIAlertViewDelegate,UISearchBarDelegate,UIActionSheetDelegate,MFMailComposeViewControllerDelegate>
{
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    if([MFMailComposeViewController canSendMail]) {
        ...
        [comp setToRecipients:[NSArray arrayWithObjects:[UserDataObjectModel Useremail], nil]];
