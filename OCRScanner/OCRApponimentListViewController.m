...
- (void)viewDidLoad
{
    ...
    for (int ssrt = 0; ssrt < 1000; ssrt++) {
        [_AppointmentDataArray addObject:[NSString stringWithFormat:@"String Value --%d",ssrt]];
    }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self.navigationController presentViewController:AppointmentDetails animated:YES completion:nil];
