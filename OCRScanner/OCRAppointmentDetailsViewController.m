...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        self=(IsIphone5)?[super initWithNibName:@"OCRAppointmentDetailsViewController" bundle:nil]:[super initWithNibName:@"OCRAppointmentDetailsViewController4s" bundle:nil];
    }
    return self;
}
- (void)viewDidLoad {
