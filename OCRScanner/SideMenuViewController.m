...
-(IBAction)MenuButtonPressed:(UIButton *)sender
{
    ...
    switch (sender.tag) {
        ...
        case 1004:
        {
            OCRApponimentListViewController *BirthdayView = [[OCRApponimentListViewController alloc] init];
        ...
        case 1007:
        {
//            OCRCameraViewViewController *BirthdayView = [[OCRCameraViewViewController alloc] init];
//            [maindelegate SetUpTabbarControllerwithcenterView:BirthdayView];
//            break;
