...
@interface ImageViewController()<UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIActionSheetDelegate, PECropViewControllerDelegate>
...
{    
    ...
    [ShadowBGView setFrame:(IsIphone5)?CGRectMake(0, 65, 320, 462):CGRectMake(0, 65, 320, 500)];
