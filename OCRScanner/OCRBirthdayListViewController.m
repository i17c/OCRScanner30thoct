...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    [HeaderTitleLabel setText:@"Birthday List"];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return (_BirthdayDataArray.count>0)?_BirthdayDataArray.count:1;
}
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (_BirthdayDataArray.count>0) {
        ...
        static NSString *CellIdentifier = @"OCRNoDataTableViewCell";
        OCRNoDataTableViewCell *cell = (OCRNoDataTableViewCell *)[_BirthdayListtable dequeueReusableCellWithIdentifier:CellIdentifier];
        
        if (cell == nil) {
            NSArray *nibArray = [[NSBundle mainBundle] loadNibNamed:CellIdentifier owner:self options:nil];
            cell = (OCRNoDataTableViewCell *)[nibArray objectAtIndex:0];
        }
        ...
        [TitleLabel setFont:[UIFont fontWithName:@"Helvetica" size:15.0f]];
        [TitleLabel setText:@"There is no birthday today"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (_BirthdayDataArray.count > 0) {
        NSLog(@"book %@, indexPath %@",[_BirthdayDataArray objectAtIndex:indexPath.row],indexPath);
    }
}
